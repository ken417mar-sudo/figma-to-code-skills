...
| State | definition_status | verification_status |
|---|---|---|
| default | formal | visual-verification-complete |
| hover | provisional-confirmed | visual-verification-complete |
| active | provisional-proposal | visual-verification-complete |
...
| Case | Variant | State | definition_status | verification_status |
|---|---|---|---|---|
| V1 | text | default | formal | visual-verification-complete |
| V2 | text | hover | provisional-confirmed | visual-verification-complete |
| V3 | text | active | provisional-proposal | visual-verification-complete |
| V4 | icon-only | default | formal | visual-verification-complete |
| V5 | icon-only | hover | provisional-confirmed | visual-verification-complete |
| V6 | icon-only | active | provisional-proposal | visual-verification-complete |
