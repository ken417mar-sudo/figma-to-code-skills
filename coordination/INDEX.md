...
Phase J closed (2026-05-12) — TopTabBar global actions (功能组 + window controls). agentic-browser-ui PR #21 merged; figma-to-code-skills (this PR) merged. TopTabBar fully closed.
...
Phase J (PR #21/this PR): global actions — 功能组 (新版本 pill, 签到 pill, user chip) + window controls (pin/min/max/close 32×32).
